...
export class QuestionsServiceProvider  {
    ...
    constructor(public http: HttpClient) {
        console.log("Hello QuestionsServiceProvider Provider");
    ...
    getItems(): Observable<object[]> {
        ...
        return this.http.get(this.baseURL + '/api/questions').pipe(
    ...
    removeItem(id) {
        ...
        this.http.delete(this.baseURL + "/api/questions/" + id).subscribe(res => {
            this.items = res;
    ...
    addItem(item)  {
        console.log('#### adding item', item.problem);
